...
class Attention(nn.Module):
    def __init__(self, in_c, att_hiddem_size, final_output_dim):
        super(Attention , self).__init__()
        
        self.model_name = "Multi-head Self-attention"
        self.num_attention_heads = 2
        self.attention_input = in_c
    ...
    def forward(self, flow_x, graph_data):
        last_output = self.attentionlayer(flow_x)
