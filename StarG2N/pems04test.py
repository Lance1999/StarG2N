...
def main():
    ...
    batch_size_ = 64
    train_data = LoadData(data_path=["/data/PEMS04/PEMS04.csv","/data/PEMS04/PEMS04.npz"],
                          num_nodes=307,
                          divide_rate=[0.8, 0.2],
                          history_length=12,
                          pre_length = 12,
    ...
    test_data = LoadData(data_path=["/data/PEMS04/PEMS04.csv","/data/PEMS04/PEMS04.npz"],
                          num_nodes=307,
                          divide_rate=[0.8, 0.2],
                          history_length=12,
                          pre_length = 12,
    ...
    test2.to_csv("/StarG2N/pems04/PEMS04_result.csv")
    ...
    for i in range(10):
        ...
        torch.save(my_net, "/StarG2N/pems04/PEMS04_{}.pt".format(i))
        ...
        test2.to_csv("/StarG2N/pems04/PEMS04_result.csv",mode="a",header=False)
        
        plt.title("train_loss")
        plt.xlabel("epoch")
        plt.ylabel("loss")
        plt.plot(loss_visio)
        plt.savefig("/StarG2N/pems04/PEMS04_test_{}.png".format(i))
        plt.show()
