...
from model_v7 import GraphConv_one_cheb
...
from traffic_dataset_v4 import LoadData
...
def main():
    ...
    batch_size_ = 32
    train_data = LoadData(data_path=["/data/PEMS08/PEMS08.csv","/data/PEMS08/PEMS08.npz"],
                          num_nodes=170,
                          divide_rate=[0.8, 0.2],
                          history_length=12,
                          pre_length = 12,
    ...
    test_data = LoadData(data_path=["/data/PEMS08/PEMS08.csv","/data/PEMS08/PEMS08.npz"],
                          num_nodes=170,
                          divide_rate=[0.8, 0.2],
                          history_length=12,
                          pre_length = 12,
    ...
    test2.to_csv("/StarG2N/pems08/PEMS08_result.csv")
    ...
    for i in range(5):
        ...
        my_net = GraphConv_one_cheb(in_c=10, hid_c1=hid_c1_, K=K_, hidden_dim=hidden_dim_, att_hiddem_size=att_hidden_size_, final_output_dim=12)
        ...
        torch.save(my_net, "/StarG2N/pems08/PEMS08_{}.pt".format(temp))
        ...
        test2.to_csv("/StarG2N/pems08/PEMS08_result.csv",mode="a",header=False)
        
        plt.title("train_loss")
        plt.xlabel("epoch")
        plt.ylabel("loss")
        plt.plot(loss_visio)
        plt.savefig("/StarG2N/pems08/PEMS08_loss_{}.png".format(temp))
        plt.clf()
